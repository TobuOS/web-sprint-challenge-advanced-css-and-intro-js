...
function get20s(array, year1, year2){
  ...
  for(let i=0; i< array.length; i++){
    let X = Number(array[i]['years'].slice(0,5))
    if(X > year1 && X < year2){
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 20, 'Tristan Jones', '1996 - Present', 'Existentialism', 'African-American / Mexican', 'Honestly just a really cool dude. Buy him a beer sometime.'))
